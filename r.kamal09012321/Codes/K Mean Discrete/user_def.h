...
extern ofstream file3;//detialed working purpose
extern ofstream file4; //convergence analysis
extern ofstream file5; //statistical purpose
extern vector<setP> Red_Points;
extern vector<setP> Blue_Points;
extern vector<setC>cluster;
